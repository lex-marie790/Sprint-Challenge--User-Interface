...
display: block - takes up more space if needed
Display: inline - only takes up the space given
...
Lets you collaborat easily with teammembers. Helps prevent mess ups that can happen.
